...
<head>
	...
	<meta name="description" content="easymark.pe.kr의 관리자 페이지입니다.">
...
<body>
					...
					<form class="form-horizontal" action="adminLogin" method="post">
						<fieldset>
							<div class="input-prepend" title="Username" data-rel="tooltip">
								<span class="add-on"><i class="icon-user"></i></span><input autofocus class="input-large span10" name="adminId" id="adminId" type="text" placeholder="admin" />
							</div>
	...
	<!-- jQuery UI -->
	<script src="js/admin/jquery-ui-1.8.21.custom.js"></script>
</body>
</html>
