...
<body>
		...
		<!--Content start-->
			...
			<form id="loginForm" action="login" method="post" data-ajax="false">
				...
				<fieldset class="ui-grid-a">
						<div class="ui-block-a"><button data-theme="b" type="button" class="ui-btn-hidden" aria-disabled="false">Login</button></div>
	...
	<div data-role="page" data-theme="b" id="registerPage">
		...
		<div data-role="content" data-theme="b">
			<!--Register form start-->
			<form id="registerForm" action="register" method="post" data-ajax="false">
				...
				<fieldset class="ui-grid-a">
						<div class="ui-block-a"><button data-theme="b" type="button" class="ui-btn-hidden" aria-disabled="false">가입</button></div>
						<div class="ui-block-b"><button data-theme="b" type="reset" class="ui-btn-hidden" aria-disabled="false">Clear</button></div>
